...
from "nodejs_lake"."main_cleansed"."clean_issues" i
inner join "nodejs_lake"."main_application"."dim_contributor" c  -- Utilise inner join pour assurer que nous n'avons que des problèmes avec des contributeurs valides
